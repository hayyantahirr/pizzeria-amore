...
const AdminUpdateCard = ({ product, isOpen, onClose, onProductUpdated }) => {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      if (useFileUpload && fileInputRef.current && fileInputRef.current.files[0]) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      ...
      >
        <div className="p-6">
          <h2 className="text-2xl font-bold mb-4 text-gray-800 dark:text-white">Update Product</h2>
          ...
          <div className="max-h-[70vh] overflow-y-auto pr-2">
            <form onSubmit={handleUpdate}>
              ...
              {!useFileUpload ? (
                ...
                <div className="mb-4">
                  <label className="block text-gray-700 dark:text-gray-300 mb-2">Upload Image</label>
                  <input
                    type="file"
                    ref={fileInputRef}
                    className="w-full px-3 py-2 border rounded-md dark:bg-gray-700 dark:text-white dark:border-gray-600"
