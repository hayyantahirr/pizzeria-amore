    ...
    <>
      ...
      <section className="mt-15 relative w-full min-h-[50vh] flex items-center justify-center overflow-hidden">
        <div className="relative z-10 flex flex-col items-start text-left w-full max-w-5xl px-4 py-16 md:py-20 mx-auto">
          ...
          {/* Heading */}
          <AnimateOnScroll animation="fadeInUp" delay={0.2} duration={1}>
          ...
          {/* Paragraph */}
          <AnimateOnScroll animation="fadeIn" delay={0.4} duration={1.2}>
      ...
      <section className="w-full px-4 py-10 md:py-14 bg-gray-50">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          <AnimateOnScroll animation="fadeInRight" duration={0.8}>
            <div>
          ...
          <AnimateOnScroll animation="fadeInLeft" duration={0.8} delay={0.2}>
      ...
      <section className="w-full px-4 py-12 md:py-16">
        <div className="max-w-2xl mx-auto">
          <AnimateOnScroll animation="fadeInUp" duration={1}>
            <ContactCard />
          </AnimateOnScroll>
        </div>
      </section>
